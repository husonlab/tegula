...
import tegula.main.editor.TilingEditorTabController;
...
public class FDomainEditor {
    ...
    public FDomainEditor(TilingEditorTab tilingEditorTab) {
        ...
        fDomainPane = new FDomainPane(tilingEditorTab.getTilingPane().getExtendedTiling());

        tilingEditorTab.getTilingPane().getExtendedTiling().lastUpdateProperty().addListener((e) -> fDomainPane.update());
