 ...
 * Daniel Huson, 4.2019
 */
abstract public class TilingMeshesBase {
    ...
    final FundamentalDomainMeshes fundamentalDomainMeshes;
     ...
     * @param ds
     */
    public TilingMeshesBase(TilingStyle tilingStyle, DSymbol ds) {
     ...
     * @return tiling
     */
    public static TilingMeshesBase createTiling(TilingStyle tilingStyle, DSymbol ds) {
        switch (ds.computeGeometry()) {
            case Hyperbolic:
                return new HyperbolicTilingMeshes(tilingStyle, ds);
            case Spherical:
                return new SphericalTilingMeshes(tilingStyle, ds);
            default:
            case Euclidean:
                return new EuclideanTilingMeshes(tilingStyle, ds);
        }
    }
}
