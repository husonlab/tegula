...
import tegula.tiling_old.util.Band3D;
import tegula.tiling_old.util.BandCap3D;
import tegula.tiling_old.util.Lines;
...
public class FundamentalDomain {
    ...
    private final Group referenceSpheres = new Group();

    private ObjectProperty<Point3D> referencePoint=new SimpleObjectProperty<>();
    ...
    public void update(final DSymbol dsymbol, final FDomain fDomain, TilingStyle tilingStyle) {
        ...
        // set reference sphere:
        {
            ...
            final Sphere reference0 = new Sphere(5);
            reference0.setTranslateX(point.getX());
            reference0.setTranslateY(point.getY());
            reference0.setTranslateZ(point.getZ());
            reference0.setMaterial(new PhongMaterial(Color.RED.deriveColor(1, 1, 1, 0.5)));
            reference0.setUserData("ref0");
            ...
            referenceSpheres.getChildren().setAll(reference0, reference1, reference2);
        }
    ...
    public Group getReferenceSpheres() {
        return referenceSpheres;
    }
    ...
    public ReadOnlyObjectProperty<Point3D> referencePointProperty() {
        return referencePoint;
    }

    private void setReferencePoint(Point3D referencePoint) {
