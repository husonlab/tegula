...
package tegula.tiling_old.util;
...
import tegula.tiling_old.FundamentalDomain;
...
public class Band3D extends Group {
    ...
    public static TriangleMesh[] connectEdges(Point3D point0, Point3D point1, FDomain fDomain, double bandWidth, double capSize, double above) {
        ...
        if (fDomain.getGeometry() == Geometry.Euclidean) {
            ...
            points3d[4] = Tools.midpoint3D(Geometry.Euclidean, point0, points3d[0]);
            points3d[5] = Tools.midpoint3D(Geometry.Euclidean, point0, points3d[1]);
            points3d[6] = Tools.midpoint3D(Geometry.Euclidean, point1, points3d[2]);
            points3d[7] = Tools.midpoint3D(Geometry.Euclidean, point1, points3d[3]);
