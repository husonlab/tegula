/*
 * TilingEditorTab.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class TilingEditorTab extends Tab implements IFileBased, Closeable, Printable {
    ...
    public TilingEditorTab(DSymbol dSymbol0, String name) {
        ...
        // the Export menu button, and the name and QR code that float over the main pane
        ExportControls.setup(this);
