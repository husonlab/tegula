/*
 * FDomainPane.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class FDomainPane extends StackPane {
    ...
    public void update() {
        ...
        BitSet invisibleTileFlags=null;
        if(TilingStyle.hideFirstTile.get()) {
            invisibleTileFlags=BitSetUtils.asBitSet(ds.orbitMembers(0,1,1));
        }
        ...
        for (int a = 1; a <= ds.size(); a++) {
            ...
            if (tilingStyle.isShowFaces() && !(invisibleTileFlags!=null && invisibleTileFlags.get(a)))
