/*
 * Tegula.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class Tegula extends Application {
    ...
    protected static void parseArguments(String[] args) throws CanceledException, UsageException {
        ...
        options.setAuthors("Daniel H. Huson, with contributions from Klaus Westphal, Ruediger Zeller, Julius Vetter and Cornelius Wiehl.");
