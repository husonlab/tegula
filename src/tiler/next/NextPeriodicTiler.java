 ...
 * Daniel Huson, 4.2019
 */
public class NextPeriodicTiler extends Application {
    ...
    private static void parseArguments(String[] args) throws CanceledException, UsageException {
        ...
        final ArgsOptions options = new ArgsOptions(args, NextPeriodicTiler.class, "PeriodicTiler - 2D tiler");
        ...
        if (showVersion) {
            ...
            System.err.println(jloda.util.Version.getVersion(NextPeriodicTiler.class, ProgramPropertiesFX.getProgramName()));
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final NextWindow mainWindow = new NextWindow();
